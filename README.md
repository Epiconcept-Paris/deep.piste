...
The playbook runs the successive steps to launch transfer. To run transfer from servers to SFTP, the main Python command can be found in _/ansible/export_hdh/roles/running_export/tasks/main.yml_ :
